...
/* Pin function select register 0 引脚功能号选择寄存器*/
typedef struct {
  __REG32 P0_0            :2;
  __REG32 P0_1            :2;
  __REG32 P0_2            :2;
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(ADCR, 0xE0034000,__READ_WRITE,__adcr_bits);     //AD控制寄存器
__IO_REG32_BIT(ADDR, 0xE0034004,__READ_WRITE,__addr_bits);     //AD状态寄存器
#define ADGDR     ADDR
...
__IO_REG32_BIT(ADSTAT, 0xE0034030,__READ ,__adstat_bits);         //AD转换完成标志位
